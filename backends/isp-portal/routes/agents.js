...
const DEFAULT_AGENTS = [
  ...
  { id:'agent-006', name:'Small Biz Coach', slug:'small-biz-coach', description:'Business planning, marketing, and operations advice for rural small business owners.', category:'Business', creatorRole:'etheros', status:'live', pricingType:'addon', priceMonthly:4.99, activationCount:0, isEnabled:true, modelId:'llama3.2:3b', systemPrompt:'You are a small business coach for rural entrepreneurs. Help with business planning, marketing strategies, financial basics, and operational challenges.' },
...
module.exports = function agentsRouter(DATA_DIR) {
  ...
  router.patch('/:id', (req, res) => {
    ...
    const map = { name:'name', description:'description', category:'category', status:'status',
                  modelId:'model_id', systemPrompt:'system_prompt',
